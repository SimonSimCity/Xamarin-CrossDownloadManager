...
namespace DownloadExample.Droid
{
    ...
    public class MainActivity : Activity
    {
        ...
        private async void ButtonOnClick(object control, EventArgs eventArgs)
        {
            ...
            var rootFolder = GetExternalFilesDir(global::Android.OS.Environment.DirectoryDownloads).AbsolutePath;
